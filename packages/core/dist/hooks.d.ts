...
declare function getAugmentedHooks<T extends Connector>(connector: T, { useChainId, useAccounts }: ReturnType<typeof getStateHooks>, { useAccount, useIsActive }: ReturnType<typeof getDerivedHooks>): {
